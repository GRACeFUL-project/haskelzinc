...
planning = [
  ...
  Declare $ Declaration (Variable (Par, Set Int, "Products")) [] (Just (Bi mz_range (IConst 1) (Var "nproducts"))),
  ...
  Declare $ Declaration (Variable (Par, Set Int, "Resources")) [] (Just (Bi mz_range (IConst 1) (Var "nresources"))),
  ...
  Declare $ Declaration (Variable (Par, Int, "mproducts")) [] (Just (Call $ mz_max [ArrayComp (Call $ mz_min [ArrayComp (Bi mz_idiv (ArrayElem "capacity" [Var "r"]) (ArrayElem "consumption" [Var "p", Var "r"])) ([(["r"], Var "Resources")], (Just (Bi mz_gt (ArrayElem "consumption" [Var "p", Var "r"]) (IConst 0))))]) ([(["p"], Var "Products")], Nothing)])),
  Declare $ Declaration (Variable (Dec, Array [AOS "Products"] (Dec, Range (IConst 0) (Var "mproducts")), "produce")) [] Nothing,
  Declare $ Declaration (Variable (Dec, Array [AOS "Resources"] (Dec, Range (IConst 0) (Call $ mz_max [Var "capacity"])), "used")) [] Nothing,
...
knapsack = [
  ...
  Declare $ Declaration (Variable (Par, Set Int, "Items")) [] (Just (Bi mz_range (IConst 1) (Var "n"))),
...
australia = [
  ...
  Declare $ Declaration (Variable (Par, Int, "nc")) [] (Just (IConst 3)),
